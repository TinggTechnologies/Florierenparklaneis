...
<div class="row justify-content-center">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Existing Assignment <i class="bi bi-people" style="font-size: 1.2rem; color: green;"></i></a></li>
                </ol>
  </nav>
                  ...
                  while($fetch = $result->fetch_assoc()){
                    ...
                    if($get_result->num_rows > 0){
                      ...
                      <tr>
                          ...
                          <td><a href="admin-existing-library-check.php?library_id='.$fetch['assignment_id'].'"><i class="bi bi-box-arrow-up fs-5" style="color: green;"></i></a></td>
                        </tr>
                      ';
                    }
                    echo '
