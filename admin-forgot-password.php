...
require "backend/admin-forgot-password.php";
                  ...
                  <div class="text-center">
                    ...
                    <div class="col-12">
                      <div class="input-group">
                        ...
                        <input type="text" name="email" class="form-control form_data" id="email" placeholder="enter admin unique id" value="<?php if(isset($email)){
                        echo $email;
                      } ?>">
                      </div>
