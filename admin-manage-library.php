...
<div class="row justify-content-center">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Manage Library <i class="bi bi-people" style="font-size: 1.2rem; color: green;"></i></a></li>
                </ol>
  </nav>
          ...
          <select name="class" class="form-control form_data">
                ...
                while($row = $result->fetch_assoc()){
                   ...
                   ';
                    ...
                    ?>
                     ...
                     <button type="submit" class="btn btn-success form-control mb-3" name="admin-manage-library" style="border-radius: 15px;">Manage Library</button>
                     <a href="admin-existing-library.php">View Existing Library</a>
                     </div>
              </form>
           ...
           <?php 
            ...
            if (isset($_POST['admin-manage-library'])) {
              ...
              if(count($error) === 0){
                $sql = "SELECT * FROM library WHERE class='$class' and verify='0' ORDER BY library_id DESC";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->get_result();
                if($result->num_rows > 0){
                  ...
                  while($fetch = $result->fetch_assoc()){
                    ...
                    if($get_result->num_rows > 0){
                      ...
                      <tr>
                          ...
                          <td><a href="admin-view-library.php?library_id='.$fetch['library_id'].'"><i class="bi bi-box-arrow-up fs-5" style="color: green;"></i></a></td>
                        </tr>
                      ';
                    }
