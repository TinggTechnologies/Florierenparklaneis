...
?>
    ...
    <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="form" method="POST" class="typing-area">
        <div id="error"></div>
        <textarea placeholder="type something here..." id="message" name="message" class="input-field"></textarea>
        <input type="hidden" name="outgoing_id" class="form_data" id="outgoing_id" value="<?= $row['unique_id']; ?>">
