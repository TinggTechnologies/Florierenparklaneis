...
<div class="container mt-5 pt-5">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Edit Library</a></li>
                </ol>
  </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          if($result->num_rows > 0){
            ...
            $sql = "SELECT * FROM library WHERE staff_id='$staff_id' ORDER BY library_id DESC";
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            $result = $stmt->get_result();
            if($result->num_rows > 0){
...
<div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="row g-0 text-center">
                    <h3 class="card-title fw-bold pt-0"><i class="bi bi-card-heading fs-5"></i> '.$fetch['course'].'</h3>
                    <p class="card-text pt-0">'.$fetch['about'].'</p>
                    <hr>
                 
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="edit-view-library.php?library_id='.$fetch['library_id'].'" class="btn btn-success form-control" style="border-radius: 15px;">Edit Book</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      ';
          ...
          <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No Book</div>";
        }} else{
          ?>
