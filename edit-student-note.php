      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          if($result->num_rows > 0){
            ...
            $sql = "SELECT * FROM lesson_note WHERE staff_id='$staff_id' ORDER BY lesson_note_id DESC";
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            $result = $stmt->get_result();
            if($result->num_rows > 0){
...
<div class="col-xxl-4 col-md-6">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="edit-view-note.php?library_id='.$fetch['lesson_note_id'].'" class="btn btn-success form-control" style="border-radius: 15px;">Edit Note</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      ';
          ...
          <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No Note</div>";
        }} else{
          ?>
