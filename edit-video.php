...
<div class="container mt-5 pt-5">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Edit YouTube Video Link</a></li>
                </ol>
  </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          if($result->num_rows > 0){
            ...
            $sql = "SELECT * FROM video WHERE staff_id='$staff_id' ORDER BY id DESC";
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            $result = $stmt->get_result();
            if($result->num_rows > 0){
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="edit-view-video.php?library_id='.$fetch['id'].'" class="btn btn-success form-control" style="border-radius: 15px;">Edit Link</a>
                    </div>
                  </div>
                </div>
              </div>
