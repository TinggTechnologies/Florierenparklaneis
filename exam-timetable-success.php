    ...
    <section class="section pt-5 mt-5">
      <div class="row d-flex flex-column align-items-center justify-content-center">
        ...
        <i class="bi bi-check-circle-fill" style="font-size: 3rem; color: green;"></i>
              ...
              <p class="text-center">Dear <span style="color: green;"><?= $row['lastname']; ?>,</span> You have successfully uploaded <span style="color: green;"><?= $_SESSION['timetable-user']; ?></span> Class TimeTable.
              </p>
