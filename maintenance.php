...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Maintenance <i class="bi bi-receipt-cutoff" style="font-size: 1.2rem;"></i></a></li>
                </ol>
  </nav>
...
?>
                   <h3 class="mt-5 fw-bold mb-3 text-success">Maintenance</h3>

                   <div class="container text-center mt-5 mb-5">
                <img src="./assets/img/florieren/logout1.png" style="height : 16rem;" class="img-fluid" alt="">
              </div>

              <div class="container">
                <p class="text-danger">This page is currently under maintenance, will be available for view much later.</p>
                <a href="./student-dashboard.php" class="btn btn-success form-control mt-3" style="border-radius: 15px;">Move to Dashboard</a>
              </div>
