        ...
        if($result->num_rows > 0){
            ...
            while($rows = $result->fetch_assoc()){
                ...
                <tr>
                        ...
                        <td><a href="manage-fees-payment.php?unique_id='.$rows['student_id'].'&&fee_id=' .$rows['scratch_card_id'].' "><i style="font-size: 1.3rem;" class="bi bi-pencil-square"></i></a></td>
                    </tr>
                ';
            }}
            echo '
            ...
            <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No Payment</div>";
        }
