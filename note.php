...
<div class="container mt-5 pt-4">
  ...
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Lesson Note</a></li>
                </ol>
  </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          if($result->num_rows > 0){
            ...
            $sql = "SELECT * FROM lesson_note WHERE class='$class' ORDER BY lesson_note_id DESC";
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            $result = $stmt->get_result();
            if($result->num_rows > 0){
...
<div class="col-xxl-4 col-md-6">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="view-note.php?library_id='.$fetch['lesson_note_id'].'" class="btn btn-success form-control" style="border-radius: 15px;">Lesson Note</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      ';
          ...
          <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No Note Found</div>";
        }} else{
          ?>
