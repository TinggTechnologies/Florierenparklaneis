          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php if($row['v_email'] === '0'){
                      echo $row['email']; ?> <a class="btn btn-danger" href="verify-email.php">Verify Email Address</a>
                     <?php } else {
                      echo $row['email']; 
                      }
                      ?></div>
                  ...
                  <div class="text-center">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <a href="update-picture.php" class="btn btn-success btn-sm" title="Upload new profile image"><i class="bi bi-upload text-white"></i></a>
                        </div>
                      </div>
                    </div>
                ...
                <?php require "backend/change-staff-password.php"; ?>
...
<div class="text-center">
  <button type="submit" class="btn btn-success px-5" name="cstaffp-btn" style="border-radius: 15px;">Change Password</button>
</div>
