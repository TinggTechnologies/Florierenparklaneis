...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
  ...
  <div class="mb-3 mt-3">
    ...
    if($student_result->num_rows > 0){
        ...
        $student_names = $student_rows['firstname'] . ' ' . $student_rows['lastname'];
...
?>
  ...
  <button type="submit" class="btn btn-primary form-control bg-success" name="staff-update-result-btn">Upload Result</button>
</form>
</div>
</section>
