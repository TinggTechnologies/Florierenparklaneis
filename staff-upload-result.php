...
<nav>
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Upload Result <i class="bi bi-people" style="font-size: 1.2rem; color: green;"></i></a></li>
              </ol>
</nav>
...
<?php
 ...
 <div class="col-lg-4">         
            ...
            <div class="text-center">
              ...
              <p>You can only Upload the result of <span class="text-success fw-bold">'.$row['class'].'</span> class because you are their class teacher.</p>
              ...
              while($fetch = $result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td><a href="upload-student-result.php?student_id='.$fetch['student_id'].'"><i class="bi bi-box-arrow-up fs-5" style="color: green;"></i></a></td>
                  </tr>
                ';
              }
            ?>
              ...
              <?php 
                ...
                <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No New Student</div>";
              }
