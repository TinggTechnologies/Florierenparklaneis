          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Parents</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 d-flex justify-content-between align-items-center py-3">
                        <img src="./assets/img/florieren/event5.jpg" class="rounded-circle" height="50px" alt="">
                        <div class="ms-3">
                            <h4 style="font-size: 1.2rem;">Ndunche Joseph</h4>
                  ...
                  <form method="POSt" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <a href="update-student-picture.php" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload text-white"></i></a>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="firstname" type="text" class="form-control" id="firstname" value="<?php if(isset($row['student_firstname'])){
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="lastname" type="text" class="form-control" id="lastname" value="<?php if(isset($row['student_lastname'])){
