      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          if($result->num_rows > 0){
            ...
            $sql = "SELECT * FROM video WHERE class='$class' ORDER BY id DESC";
            $stmt = $conn->prepare($sql);
            $stmt->execute();
            $result = $stmt->get_result();
            if($result->num_rows > 0){
...
<div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="row g-0 text-center">
                    ...
                    <p class="card-text pt-0">'.$fetch['date'].'</p>
                    <hr>
                 
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="view-video.php?library_id='.$fetch['id'].'" class="btn btn-success form-control" style="border-radius: 15px;">Watch Video</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      ';
          ...
          <i class='bi bi-x-circle text-danger' style='font-size: 2.5rem;'></i><br />No Video Found</div>";
        }} else{
          ?>
