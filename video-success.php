    ...
    <section class="section pt-5 mt-5 mb-5">
      <div class="row d-flex flex-column align-items-center justify-content-center">
        ...
        <i class="bi bi-check-circle-fill" style="font-size: 3rem; color: green;"></i>
              ...
              <p class="text-center">Dear <span style="color: green;"><?php echo $row['lastname']; ?>,</span> You have successfully uploaded <?php echo $_SESSION['library_course']; ?> YouTube link to <?php echo $_SESSION['library_class']; ?> Class.
              </p>
