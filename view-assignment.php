                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="view-assignment.php?path=<?= $get_data['assignment']; ?>" class="btn btn-success form-control" style="border-radius: 15px;">Download Assignment</a>
                    </div>
                  </div>

                  <!-- <div class="row mt-3">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="submit-assignment.php?assignment_id=<?= $get_data['assignment_id']; ?>" class="btn btn-success form-control" style="border-radius: 15px;">Submit Assignment</a>
                    </div>
                  </div> -->
                </div>
              </div>
