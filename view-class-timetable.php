...
<div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">View Class TimeTable</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View Class TimeTable</h5>

              <textarea class="tinymce-editor">
            <?php
             $class = $row['class'];
             $sql = "SELECT * FROM  class_timetable WHERE class='$class' ORDER BY class_timetable_id DESC";
             $stmt = $conn->prepare($sql);
             $stmt->execute();
             $result = $stmt->get_result();
             if($result->num_rows > 0){
               ...
               echo $data['timetable']; 
                ...
                echo "No TimeTable Yet, Check Later";
             }
            ?>
            </textarea>
