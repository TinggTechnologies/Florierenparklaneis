...
<div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">View Exam TimeTable</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View Exam TimeTable</h5>

              <textarea class="tinymce-editor">
            <?php
            $result = '';
             $class = $row['class'];
             if($class == 'Jss-1' || $class == 'Jss-2' || $class == 'Jss-3'){
                $result .= "junior";
             } else{
                $result .= "senior";
             }
             $sql = "SELECT * FROM  exam_timetable WHERE user='$result' ORDER BY exam_timetable_id DESC";
             $stmt = $conn->prepare($sql);
             $stmt->execute();
             $result = $stmt->get_result();
             if($result->num_rows > 0){
