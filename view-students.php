...
<div class="row justify-content-center">
 <div class="col-lg-4">
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">View Students <i class="bi bi-people" style="font-size: 1.2rem; color: green;"></i></a></li>
                </ol>
  </nav>
 ...
 <div class="col-lg-4">           
            ...
            <div class="text-center">
              ...
              <p>You can only manage <span class="text-success fw-bold">'.$row['class'].'</span> class because you are their class teacher.</p>
              ...
              while($fetch = $result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td><a href="view-student-profile.php?student_id='.$fetch['student_id'].'"><i class="bi bi-box-arrow-up fs-5" style="color: green;"></i></a></td>
                  </tr>
                ';
              }
            ?>
